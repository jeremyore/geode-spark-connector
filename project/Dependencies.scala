...
object Dependencies {
  ...
  object Compile {
    val sparkStreaming = "org.apache.spark" %% "spark-streaming" % "2.1.0"
    val sparkSql = "org.apache.spark" %% "spark-sql" % "2.1.0"
    val geode = "org.apache.geode" % "geode-core" % "1.1.0" excludeAll(ExclusionRule(organization = "org.jboss.netty") )
  }

  object Test {
    val scalaTest = "org.scalatest" % "scalatest_2.11" % "2.2.6" % "it, test" //scala test framework
